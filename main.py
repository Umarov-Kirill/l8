...
class MainWindow(QWidget):
    ...
    def connect_to_db(self):
        self.conn = psycopg2.connect(database="bot_r",
                        user="postgres",
                        password="09092002bN!",
                        host="localhost",
                        port="5432")
    ...
    def _create_monday_table(self):
        ...
        self.monday_table.setHorizontalHeaderLabels(["ID", "Teacher", "Subject", "Room", "Time", "", ""])
    ...
    def _create_tuesday_table(self):
        ...
        self.tuesday_table.setHorizontalHeaderLabels(["ID", "Teacher", "Subject", "Room", "Time", "", ""])
    ...
    def _create_wednesday_table(self):
            ...
            self.wednesday_table.setHorizontalHeaderLabels(["ID", "Teacher", "Subject", "Room", "Time", "", ""])
    ...
    def _create_thursday_table(self):
        ...
        self.thursday_table.setHorizontalHeaderLabels(["ID", "Teacher", "Subject", "Room", "Time", "", ""])
    ...
    def _create_friday_table(self):
        ...
        self.friday_table.setHorizontalHeaderLabels(["ID", "Teacher", "Subject", "Room", "Time", "", ""])
    ...
    def _update_monday_table(self):
        self.conn.rollback()
        self.cursor.execute("SELECT * FROM timetable WHERE day='Понедельник1' ORDER BY id")
        records = list(self.cursor.fetchall())
    ...
    def _update_tuesday_table(self):
        self.conn.rollback()
        self.cursor.execute("SELECT * FROM timetable WHERE day='Вторник1' ORDER BY id ASC")
        records = list(self.cursor.fetchall())
    ...
    def _update_wednesday_table(self):
        self.conn.rollback()
        self.cursor.execute("SELECT * FROM timetable WHERE day='Среда1' ORDER BY id ASC")
        records = list(self.cursor.fetchall())
    ...
    def _update_thursday_table(self):
        self.conn.rollback()
        self.cursor.execute("SELECT * FROM timetable WHERE day='Четверг1' ORDER BY id ASC")
        records = list(self.cursor.fetchall())
    ...
    def _update_friday_table(self):
        self.conn.rollback()
        self.cursor.execute("SELECT * FROM timetable WHERE day='Пятница1' ORDER BY id ASC")
        records = list(self.cursor.fetchall())
    ...
    def _del_day_from_teacher(self, rowNum):
        ...
        self.cursor.execute("UPDATE timetable SET  teacher = '7' WHERE teacher = %s", (row[0],))
    ...
    def _add_day_from_monday(self, rowNum):
        self.cursor.execute("insert into timetable (day) VALUES ('Понедельник1')")
        self.conn.commit()
    ...
    def _add_day_from_tuesday(self, rowNum):
        self.cursor.execute("insert into timetable (day) VALUES ('Вторник1')")
        self.conn.commit()
    ...
    def _add_day_from_wednesday(self, rowNum):
        self.cursor.execute("insert into timetable (day) VALUES ('Среда1')")
        self.conn.commit()
    ...
    def _add_day_from_thursday(self, rowNum):
        self.cursor.execute("insert into timetable (day) VALUES ('Четверг1')")
        self.conn.commit()
    ...
    def _add_day_from_friday(self, rowNum):
        self.cursor.execute("insert into timetable (day) VALUES ('Пятница1')")
        self.conn.commit()
    ...
    def _change_day_from_subject(self, rowNum):
        ...
        try:
            print(row)
            self.cursor.execute("UPDATE subject SET name = %s WHERE id = %s", (row[0], row[1]))
            self.conn.commit()
        except:
            QMessageBox.about(self, "Error", "Fill all")
    ...
    def _change_day_from_monday(self, rowNum):
        ...
        try:
            print(row)
            self.cursor.execute("UPDATE timetable SET subject = %s, room_numb = %s, start_time = %s, teacher = %s WHERE id = %s", (row[2], str(row[3]), str(row[4]), row[1], row[0]))
            self.conn.commit()
        except Exception as e:
            print(e)
            QMessageBox.about(self, "Error", "Fill all")
